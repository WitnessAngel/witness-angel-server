...
@convert_exceptions_to_jsonrpc_status_slugs
@validate_input_parameters
def submit_decryption_request_view(request, authenticator_keystore_uid, revelation_requestor_uid, revelation_request_description,
...
@convert_exceptions_to_jsonrpc_status_slugs
@validate_input_parameters
def accept_revelation_request_view(request, revelation_request_uid, symkey_decryption_results, authenticator_keystore_secret):
