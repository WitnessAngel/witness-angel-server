...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "max_free_keys_per_type", nargs="?", type=int, default=10
        )
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("Launching generate_free_keys.py script with max_free_keys_per_type=%s" % max_free_keys_per_type)

        while True:
            self.stdout.write("New iteration of generate_free_keypair_for_least_provisioned_key_type()")
