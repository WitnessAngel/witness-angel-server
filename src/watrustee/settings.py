...
INSTALLED_APPS = [
    ...
    "rest_framework",
    "watrustee",  # New form "watrustee.apps.WatrusteeConfig" is not supported by PyInstaller
]
...
WSGI_APPLICATION = "watrustee.wsgi.application"
...
# AUTH_USER_MODEL = 'watrustee.PublicAuthenticator'
